...
if [ -f "$file_path" ]; then
    ...
    while IFS= read -r line || [ -n "$line" ]; do
        ...
        CUDA_VISIBLE_DEVICES=5 python src/main.py --mode sft_likelihood --likelihood_func diff --target_persona $line --exp_name gptj_picle --model_dir /nobackup2/froilan/checkpoints/gptj/gpt-j-6b/ --model gptj --output_dir /nobackup2/froilan/checkpoints/gptj_sft/persona_sft_label_agnostic/ --likelihood_use_epoch 4
