...
if [ -f "$file_path" ]; then
    ...
    while IFS= read -r line || [ -n "$line" ]; do
        ...
        CUDA_VISIBLE_DEVICES=6 python src/main.py --mode prompt_engineering --target_persona $line --exp_name gptj_pe_ins --model_dir /nobackup2/froilan/checkpoints/gptj/gpt-j-6b/ --model gptj
