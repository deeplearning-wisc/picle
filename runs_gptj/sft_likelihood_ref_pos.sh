...
if [ -f "$file_path" ]; then
    ...
    while IFS= read -r line || [ -n "$line" ]; do
        ...
        CUDA_VISIBLE_DEVICES=2 python src/main.py --mode sft_likelihood --likelihood_func diff --target_persona $line --exp_name vicuna_likelihood_ref_pos --model_dir /nobackup2/froilan/checkpoints/vicuna/vicuna-7b-v1.5/ --model vicuna --max_input_len 400 --output_dir /nobackup2/froilan/checkpoints/vicuna_sft/persona_sft/ --likelihood_use_epoch 10 --pos_label_sample_only
