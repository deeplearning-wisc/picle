...
if [ -f "$file_path" ]; then
    ...
    while IFS= read -r line || [ -n "$line" ]; do
        ...
        CUDA_VISIBLE_DEVICES=7 python src/main.py --mode train_sft --target_persona $line --exp_name gptj_personasft --model_dir /nobackup2/froilan/checkpoints/gptj/gpt-j-6b/ --model gptj --output_dir /nobackup2/froilan/checkpoints/gptj_sft/persona_sft_label_agnostic/
