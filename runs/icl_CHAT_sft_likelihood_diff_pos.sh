...
if [ -f "$file_path" ]; then
    ...
    while IFS= read -r line || [ -n "$line" ]; do
        ...
        CUDA_VISIBLE_DEVICES=2 python src/main.py --mode sft_likelihood --likelihood_func diff --target_persona $line --exp_name llama-chat_sft_likelihood_diff_pos --model_dir /nobackup2/froilan/checkpoints/llama-2/Llama-2-7b-chat-hf/ --max_input_len 300 --pos_label_sample_only --output_dir /nobackup2/froilan/checkpoints/persona_sft/ --likelihood_use_epoch 6

    done < "$file_path"
else
    echo "File not found: $file_path"
fi
CUDA_VISIBLE_DEVICES=0 python src/main.py --mode sft_likelihood --likelihood_func diff --target_persona narcissism --exp_name llama-chat_sft_likelihood_diff_pos --model_dir /nobackup2/froilan/checkpoints/llama-2/Llama-2-7b-chat-hf/ --max_input_len 300 --pos_label_sample_only --output_dir /nobackup2/froilan/checkpoints/persona_sft/ --likelihood_use_epoch 6
CUDA_VISIBLE_DEVICES=1 python src/main.py --mode sft_likelihood --target_persona narcissism --exp_name llama-chat_sft_likelihood_pos --model_dir /nobackup2/froilan/checkpoints/llama-2/Llama-2-7b-chat-hf/ --max_input_len 300 --pos_label_sample_only --output_dir /nobackup2/froilan/checkpoints/persona_sft/ --likelihood_use_epoch 6
CUDA_VISIBLE_DEVICES=2 python src/main.py --mode likelihood --target_persona narcissism --exp_name llama-chat_likelihood_pos --model_dir /nobackup2/froilan/checkpoints/llama-2/Llama-2-7b-chat-hf/ --max_input_len 300 --pos_label_sample_only
