...
if [ -f "$file_path" ]; then
    ...
    while IFS= read -r line || [ -n "$line" ]; do
        ...
        CUDA_VISIBLE_DEVICES=7 python src/main.py --mode prompt_engineering --target_persona $line --exp_name llama-chat_pe_base --model_dir /nobackup2/froilan/checkpoints/llama-2/Llama-2-7b-chat-hf/
