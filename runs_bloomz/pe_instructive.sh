...
if [ -f "$file_path" ]; then
    ...
    while IFS= read -r line || [ -n "$line" ]; do
        ...
        CUDA_VISIBLE_DEVICES=5 python src/main.py --mode prompt_engineering --target_persona $line --exp_name bloomz_pe_ins --model_dir /nobackup2/froilan/checkpoints/bloomz/bloom-7b1/ --model bloomz
