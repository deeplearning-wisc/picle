...
if [ -f "$file_path" ]; then
    ...
    while IFS= read -r line || [ -n "$line" ]; do
        ...
        CUDA_VISIBLE_DEVICES=4 python src/main.py --mode knn --target_persona $line --exp_name opt_sim --model_dir /nobackup2/froilan/checkpoints/opt/opt-2.7b/ --model opt
